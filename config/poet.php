    ...
    */
    ...
    'post' => [
        'tariff' => [
            ...
            'enter_title_here' => __('Tariff name', 'sage'),
            'featured_image'   => __('Hero', 'sage'),
            'admin_cols'       => [
    ...
    */
    ...
    'taxonomy' => [
        'tariff_type' => [
            ...
            'hierarchical' => false,
            'labels' => [
                'singular' => _nx('Type', 'Types', 1, 'CT label', 'sage'),
                'plural' => _nx('Type', 'Types', 2, 'CT label', 'sage'),
            ],
        ],
        'tariff_partner' => [
            'links' => ['tariff'],
            ...
            'hierarchical' => false,
            'labels' => [
                'singular' => _nx('Partner', 'Partners', 1, 'CT label', 'sage'),
                'plural' => _nx('Partner', 'Partners', 2, 'CT label', 'sage'),
            ],
        ],
        'power_station' => [
            'links' => ['tariff'],
            ...
            'hierarchical' => false,
            'labels' => [
                'singular' => _nx('Power station', 'Power stations', 1, 'CT label', 'sage'),
                'plural' => _nx('Power station', 'Power stations', 2, 'CT label', 'sage'),
            ],
        ],
    ],
];
